...
class article_controller
{
    ...
    public static function init()
    {
        ...
        if (!ecjia_front::$controller->is_cached('article_init.dwt', $cache_id)) {
            ...
            ecjia_front::$controller->assign_title(__('帮助中心'));
        }
    ...
    public static function article_index()
    {
        ...
        ecjia_front::$controller->assign_title(__('发现'));
    ...
    public static function add_comment()
    {
        ...
        if (empty($type)) {
            ...
            if (empty($content)) {
                return ecjia_front::$controller->showmessage(__('请输入评论内容'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_ERROR);
            }
            $article_param = array(
                'token'      => ecjia_touch_user::singleton()->getToken(),
                'article_id' => $article_id,
