...
class franchisee_controller {
	...
	public static function second() {
	    ...
	    if (!ecjia_front::$controller->is_cached('franchisee_second.dwt', $cache_id)) {
	        ...
	        if (is_ecjia_error($mobile)) {
	            ...
	            foreach ($category_list as $k => $v) {
	                if (in_array($reaudit['seller_category'], $v)) {
		...
		ecjia_front::$controller->display('franchisee_second.dwt', $cache_id);
	}
...
//         RC_Logger::getlogger('info')->info($parameter);
	...
	public static function process() {
	    ...
	    if (!ecjia_front::$controller->is_cached('franchisee_process.dwt', $cache_id)) {
	    ...
	    ecjia_front::$controller->display('franchisee_process.dwt', $cache_id);
	}
