...
class touch_controller
{
    ...
    public static function search()
    {
        ...
        if (!ecjia_front::$controller->is_cached('search.dwt', $cache_id)) {
            ...
            ecjia_front::$controller->assign_title(__('搜索'));
        }
    ...
    public static function cache_set()
    {
        ...
        if (!ecjia_front::$controller->is_cached('cache_set.dwt', $cache_id)) {
            ...
            ecjia_front::$controller->assign_title(__('缓存设置'));
        }
    ...
    public static function choose_store()
    {
        ...
        ecjia_front::$controller->assign_title(__('选择门店'));
    ...
    public static function about_us()
    {
        ...
        if (!ecjia_front::$controller->is_cached('about_us.dwt', $cache_id)) {
            ...
            ecjia_front::$controller->assign_title(__('关于我们'));
        }
    ...
    {
        ecjia_front::$controller->assign('title', __('定位'));
        ecjia_front::$controller->assign_title(__('定位'));
    ...
    public static function select_city()
    {
        ...
        if (!ecjia_front::$controller->is_cached('select_location_city.dwt', $cache_id)) {
            ...
            ecjia_front::$controller->assign_title(__('选择城市'));
            ecjia_front::$controller->assign_lang();
        }
    ...
    public static function get_location_msg()
    {
        ...
        $location_content = !empty($content['result']['pois']) ? $content['result']['pois'][0] : $content['result'];
        $location_name    = !empty($location_content['title']) ? $location_content['title'] : $location_content['address'];
        ...
        if (empty($longitude) || empty($latitude)) {
            return ecjia_front::$controller->showmessage(__('定位失败，请手动选择'), ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_ERROR, array('url' => $url));
        }
