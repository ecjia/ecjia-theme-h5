...
class user_controller
{
    ...
    public static function init()
    {
        ...
        ecjia_front::$controller->assign_title(__('个人中心'));
    ...
    public static function spread()
    {
        ...
        if (!ecjia_front::$controller->is_cached('spread.dwt', $cache_id)) {
            ...
            ecjia_front::$controller->assign('share_title', __(sprintf("%s推荐这个实用的App给你~", $name)));
            ecjia_front::$controller->assign_title(__('我的推广'));
    ...
    {
        ecjia_front::$controller->assign_title(__('关注店铺'));
