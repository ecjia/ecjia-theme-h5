...
<div class="ecjia-modal">
	...
	<div class="modal-buttons modal-buttons-2 modal-buttons-vertical">
		<a href="{RC_Uri::url('location/index/select_location')}{if $smarty.cookies.index_address}&address={$smarty.cookies.index_address}{/if}{if $referer_url}&referer_url={$referer_url}{/if}"><span class="modal-button"><span class="create_address">新建收货地址</span></span></a>
