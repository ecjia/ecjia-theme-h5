...
<div class="ecjia-store-detail ecjia-store-toggle hide" id="store-seller">
	...
	<ul class="store-other-info">
		...
		<li>
			...
			<p class="other-info-result">{if $store_info.shop_address}{$store_info.shop_address}<a href="{$header_right.location_url}" class="nopjax external"><i class="shop-location-icon"></i></a>{else}暂无{/if}</p>
		</li>
		<li>
