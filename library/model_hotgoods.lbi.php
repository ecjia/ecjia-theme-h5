...
<div class="ecjia-mod ecjia-margin-b goods-index-list ecjia-new-goods" style="border-bottom:none;" >
	...
	<div class="bd">
		<ul class="ecjia-list ecjia-list-two list-page-two" id="J_ItemList" {if 1 eq 0}data-toggle="asynclist" data-loadimg="{$theme_url}dist/images/loader.gif" data-url="{url path='index/ajax_goods' args='type=hot'}"{/if} >
		</ul>
	</div>
</div>
