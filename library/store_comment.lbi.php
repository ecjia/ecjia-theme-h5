...
<div class="store-comment" data-toggle="asynclist" data-loadimg="{$theme_url}dist/images/loader.gif" data-url="{$ajax_url}{if $store_id}&store_id={$store_id}{/if}" data-type="all" data-page="2">
