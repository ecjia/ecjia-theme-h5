...
<!-- {block name="ajaxinfo"} -->
	...
	<li class="a5n single {if $val.is_disabled eq 1}disabled{/if}">
		...
		<div class="box" id="goods_cart_{$val.goods_id}">
			<span class="a5u reduce {if $val.is_disabled eq 1}disabled{/if} {if $val.attr}attr_spec{/if}" data-toggle="remove-to-cart" rec_id="{$val.rec_id}" goods_id="{$val.goods_id}" product_id="{$val.product_id}"></span>
			...
			<span class="a5v {if $val.is_disabled eq 1}disabled{/if} {if $val.attr}attr_spec{/if}" data-toggle="add-to-cart" rec_id="{$val.rec_id}" goods_id="{$val.goods_id}" product_id="{$val.product_id}"></span>
		</div>
	</li>
