...
<div class="ecjia-quickpay-form">
	<form name="quickpayForm" action="{if $direct_pay eq 1}{url path='quickpay/flow/flow_checkorder'}{else}{url path='quickpay/flow/done'}{/if}" method="post" data-url="{url path='user/quickpay/flow_checkorder'}">
