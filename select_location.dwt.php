...
<div class="ecjia-zs" id="ecjia-zs" data-type="index" data-url="{url path='touch/index/init'}">
	<div class="ecjia-zt a1">
		...
		<input class="ecjia-zv" type="text" id="search_location_list" data-toggle="search-address" data-url="{url path='touch/location/search_list'}"  name="address" placeholder='{t}选择城市、小区、写字楼、学校{/t}' maxlength="50" >
	</div>
	<div class="ecjia-zw">
