        ...
        <div class="user-info">
            <div class="user-info-top">
                ...
                <div class="top-right">
                    ...
                    <div class="rank">{$user_info.label_agent_role}</div>
                </div>
            </div>
            <div class="user-info-bottom">
                <div class="bottom-top">
                    <div class="top-left">
                        ...
                        <div class="price">{$user_info.stats.withdrawal_amount}</div>
                    </div>
                    <div class="top-right">
                ...
                <div class="bottom-bottom">
                    <div class="bottom-item">
                        <p>今日收入(元)</p>
                        <span>{$user_info.stats.today_amount}</span>
                        <span class="bottom-border"></span>
                    </div>
                    <div class="bottom-item">
                        <p>累计销售(元)</p>
                        <span>{$user_info.stats.total_order_amount}</span>
                        <span class="bottom-border"></span>
                    </div>
                    <div class="bottom-item">
                        <p>累计收入(元)</p>
                        <span>{$user_info.stats.total_amount}</span>
                    </div>
                </div>
            </div>
        </div>
