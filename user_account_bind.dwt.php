...
<form class="ecjia-user ecjia-form ecjia-user-no-border-b" name="theForm" action="{url path='user/profile/check_mobile'}" method="post" >
    {if $type eq 'mobile'}
    <div class="d_bind">
           ...
           <li>
            	...
            	<div class="form-group get_code">
            	   <label class="input_verification_code">
            			<input style="margin: 0;" type="button" value="获取验证码"  id='get_code' data-url="{url path='user/profile/get_code'}">
            		</label>
            	</div>
           </li>
        </div>
    ...
    <div class="d_bind">
        ...
        <div class="ecjia-list list-short bind">
           ...
           <li>
            	...
            	<div class="form-group get_code">
            	   <label class="input_verification_code">
            			<input type="button" value="获取验证码"  id='get_code'>
            		</label>
            	</div>
           </li>
        </div>
