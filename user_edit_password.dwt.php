	...
	<div class="ecjia-user ecjia-account ecjia-form">
        <ul>
            <div class="ecjia-list list-short form-group">
                <li>
                	<label class="input">
            			<input class="ecjia-account-passwd-on" name="old_password" placeholder="请输入旧密码" type="password" datatype="s6-16" errormsg="请输入6-16位格式的密码">
            		</label>
                </li>
                <li>
                	<label class="input">
            			<input class="ecjia-account-passwd-on" name="new_password" placeholder="请输入新密码" datatype="s6-16" type="password" errormsg="请输入6-16位格式的密码">
            		</label>
                </li>
                 <li>
            		<label class="input">
            			<input class="ecjia-account-passwd-on" name="comfirm_password" placeholder="请确认新密码" type="password" datatype="s6-16" errormsg="请输入6-16位格式的密码">
            		</label>
                </li>
            </div>
        </ul>
