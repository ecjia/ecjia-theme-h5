...
<form class="ecjia-form ecjia-login-edit-password-form ecjia-login-padding-top ecjia-user-no-border-b" name="formPassword" action="{url path='user/profile/edit_password'}" method="post" >
