...
<form class="ecjia-list ecjia-address-list" action="" method="post" id="searchForm" name="searchForm">
	...
	<div class="nav-header ecjia-margin-t ecjia-margin-b">
		<a href="https://apis.map.qq.com/tools/locpicker?search=1&type=0&backurl={url path='touch/index/init'}&key=HVNBZ-HHR3P-HVBDP-LID55-D2YM3-2AF2W&referer=ecjiaapp">
