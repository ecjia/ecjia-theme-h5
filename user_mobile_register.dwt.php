...
<form class="ecjia-login" action="{url path='user/get_password/mobile_register'}" method="post">
    <div class="ecjia-form">
    	...
    	<div class="small-submit">
            ...
            <input type="button" class="btn login-btn" value="{$lang.return_verification}" name="get_code1" data-url="{url path='user/get_password/mobile_register_account'}" id="get_code" />
        </div>
    	 <div class="around">
