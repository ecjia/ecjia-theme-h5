	...
	<div class="ecjia-checkout goods-describe ecjia-margin-b" id="two">
		<div class="flow-goods-list">
			...
			<div class="order-ft-link">
				...
				{if $list.shipping_status eq '1'} <a class="btn btn-small btn-hollow" href='{url path="user/user_order/affirm_received" args="order_id={$order.order_id}"}'>确认收货-未测试</a>{/if}
			</div>
		</div>
	</div>
</div>
